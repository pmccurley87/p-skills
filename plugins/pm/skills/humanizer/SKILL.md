...
Remove emojis from headings and bullet points unless the user explicitly wants them.
...
AI hyphenates common word pairs with perfect consistency. Humans rarely do. Less common or technical compound modifiers are fine to hyphenate.
...
A heading followed by a one-line paragraph that simply restates the heading before the real content begins. Delete the filler sentence.
